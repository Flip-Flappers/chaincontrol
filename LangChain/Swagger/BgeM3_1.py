...
class BgeM3_selector:
    ...
    def create_vector_store(self, docs):
        ...
        persist_directory = "./tmp/select_by_definitions_chroma_db"
    ...
    def create_retriever(self, vector_store, top_k=10):
    ...
    def save_documents_to_csv(self, relevant_docs, output_file="./tmp/selectbyreturn.csv"):
    ...
    def main(self):
        ...
        print("正在加载 CSV 文件...")
        documents = self.load_csv_files("csv_definitions")
        ...
        for i, doc in enumerate(relevant_docs):
            ...
            print(f"内容片段: {doc.page_content[:250]}...")
        # 保存相关文档到 CSV
        self.save_documents_to_csv(relevant_docs)


if __name__ == "__main__":
    bgeM3_selector = BgeM3_selector()
    bgeM3_selector.main()
