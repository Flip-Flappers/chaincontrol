...
class API_TAG_selector:
    ...
    def main(self):
        try:
            ...
            # 加载 CSV 文件
            loader = CSVLoader(file_path="./tmp/matched_results.csv", encoding="utf-8")
            docs = loader.load()
            ...
            # Chroma 索引的持久化存储路径
            persist_directory = "./tmp/tmp_api_paths_english"
            vector_store = None
            ...
            # 保存筛选后的数据到新 CSV 文件
            filtered_file_name = "./tmp/filtered_results.csv"
